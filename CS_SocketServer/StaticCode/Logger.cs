...
//[assembly: log4net.Config.XmlConfigurator(ConfigFile = "JD4G_log4net.config", ConfigFileExtension = "config", Watch = true)]  
/// <summary>
/// 日志管理类
/// </summary>
...
public static class Logger
{
    ...
    private static void M_单个文件追加方式()
    {
        FileAppender appender0 = new FileAppender();
        appender0.Name = "root";
        appender0.File = AppDomain.CurrentDomain.FriendlyName + "_log.txt";
